...
def events(request):
	...
	return render(request, 'events.html', {'events_all': events_all,'events_today':events_today, 'events_tmrw':events_tmrw})

def event_detail(request, event_id):
	detail_event = Event.objects.get(pk = event_id) #getting the perticular object
